...
None of this would have happened without the rest of the great team that I am proud to credit for helping me:`ChrisCruz`
Many thanks to `ChrisCruz` for helping remove the openssl dependency! Thank you, Chris Cruz or MestreBond or `MestreBo` or `CyberGuardian`
